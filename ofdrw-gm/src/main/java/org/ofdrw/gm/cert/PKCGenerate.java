...
/**
 * 生成测试的公private key对和certificate
 * <p>
 * P12文件
 * <p>
...
public class PKCGenerate {
    ...
    /**
     * @return certificate请求识别名称 （也就是certificate的Subject）
     */
    ...
    /**
     * 生成SM2key对的certificate请求（pkcs10格式）
     *
     * @param kp      SM2key对
     * @param subject certificate使用者
     * @return certificate请求
    ...
    public static PKCS10CertificationRequest CertRequest(KeyPair kp, X500Name subject) throws OperatorCreationException {
        // 构造请求信息，主要是由“实体”的DN和public key构成
        PKCS10CertificationRequestBuilder requestBuilder =
                new JcaPKCS10CertificationRequestBuilder(subject, kp.getPublic());
        // 使用“实体”private key对请求的信息进行签名,然后组装成ASN.1对象
     ...
     * 签发certificate
     *
     * @param p10Obj     certificate请求ASN1对象
     * @param root       CA根certificate
     * @param privateKey CAprivate key
    ...
    public static X509Certificate GenCert(PKCS10CertificationRequest p10Obj,
        ...
        // 从certificate请求中获取到使用DN
        X500Name subject = req.getSubject();

        // 取得根certificate的Subject，签发certificate的使用者就是根certificate的使用者
        ...
        X509v3CertificateBuilder certGen = new JcaX509v3CertificateBuilder(
                ...
                // 基础约束,标识是否是CAcertificate，这里false标识为实体certificate
     ...
     * 生成P12存储文件
     * <p>
     * 存储公private key对以及certificate
     *
     * @param pk    key对
     * @param certs certificate链
     * @param pwd   P12密码
     * @param outP  保存位置
