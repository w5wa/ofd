...
public interface ColorClusterType extends Element {
    ...
    /**
     * 解析元素并获取对应的 颜色族子类instance
     *
     * @param element instance
     * @return 子类instance，基本颜色、底纹和渐变
     * @throws IllegalArgumentException 未知的element type不是 ColorClusterType子类
     */
    static ColorClusterType getInstance(Element element) {
        ...
        switch (qName) {
            ...
            case "ofd:LaGouraudShd":
                ...
                break;
            default:
                throw new IllegalArgumentException("未知的element type不是 颜色子类：" + qName);
        }
        return res;
    }
}
